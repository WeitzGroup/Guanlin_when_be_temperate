...
evo_robustness_data = importdata('data_robustness_evo_robustness_resource_explicit_KillLysogens.txt');
...
maph = [ 242/255 111/255 146/255 % pink
         97/255    151/255    244/255 % light blue
         0.8 0.8 0.8 % gray
         1 0 0 % red
         0 0 1]; % blue    
