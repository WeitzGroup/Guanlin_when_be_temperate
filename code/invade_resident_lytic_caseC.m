...
alphaS_index = 60; theta_index = length(theta_set)-8; % R_star = 1.28, S_star = 7.5e7; most up
...
% text on plots
tmptA = text(0.45, 1.65, {'$\epsilon = 1$, super immunity (full)'});
set(tmptA,'fontsize',15,'interpreter','latex');
tmptA = text(0.85, 1.4, {'$\epsilon = 0.8$'});
set(tmptA,'fontsize',15,'interpreter','latex');
tmptA = text(0.85, 1.22, {'$\epsilon = 0.6$'});
set(tmptA,'fontsize',15,'interpreter','latex');
tmptA = text(0.85, 1.09, {'$\epsilon = 0.4$'});
set(tmptA,'fontsize',15,'interpreter','latex');
tmptA = text(0.85, 0.97, {'$\epsilon = 0.2$'});
set(tmptA,'fontsize',15,'interpreter','latex');
tmptA = text(0.85, 0.89, {'$\epsilon = 0$'});
set(tmptA,'fontsize',15,'interpreter','latex');
...
Name = 'above_mutant_inv_lysogeny_indirect_benefits';
